...
##whoami
一只人畜无害的程序猿，喜欢折腾，虽然并没有折腾出什么东西。

* 2009年开始大学生涯
* 2010年开始使用Linux，不过大学里用的主力语言竟然是`java`...
* 2012年进入鹅厂实习，主力`javasccript`, 兼职拍(P)黄(H)片(P)。其实这时候才刚开始成为Vimer。在强制使用Windows的公司坚持`cygwin`+`vim`，头顶姨妈巾，装的就是13。
* 2013年正式进入鹅厂，成为一个专业拍黄片的。私下也会玩玩蟒蛇，倒腾些红宝石。
* 2015年初，提肾来到`Face++`，和一群贵系的geek过起了没羞没臊的xing福生活。

有一部相机却没拍过几张能看的照片，有一把破吉他却没弹过几个能听的调调，似乎coding是我唯一擅长的事情。
